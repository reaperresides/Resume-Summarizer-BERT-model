...
def Resume_Summarizer():
  ...
  path = r"D:\project ve\resume_project\resume_screener_old\media"  #provide a path where the directory contains all the resume e.g-->"C:\django project\media"
  summary = {"NAME":"","EMAIL":"","LOCATION":"","SKILLS":"","DEGREE":"","COMPANIES WORKED AT":"","DESIGNATION":""}
  model = spacy.load(r"D:\project ve\resume_project\resume_screener_old\resume\resume_model")
